...
public class Runner {
	...
	public static void main(String[] args) throws Exception {
		...
		while (option != 6) {
			switch (option) {
			case 1: //specify csv file
				System.out.println("Please provide path for .CSV file");
				csvFilePath = keyboard.next();
				System.out.println("This is your File path: " + csvFilePath);
				break;
			case 2: //specify input txt
				System.out.println("Specify text file to encode");
				inputFileName = keyboard.next();
				System.out.println("This is your File path: " + inputFileName);
				break;

			case 3: //specify output txt
				System.out.println("Please provide path for your output");
				outputFileName = keyboard.next();
				System.out.println("This is your File path: " + outputFileName);
				break;
			case 4: //encode text if there's no csv present or input then it will go back to the menu
				if (csvFilePath != null && inputFileName != null) {
					System.out.println("Encoding a file: " + inputFileName);
					encoder.encode(csvFilePath, inputFileName, outputFileName);
			...
			case 5: //decode text
				if (csvFilePath != null) {
					System.out.println("Please provide a file to decode:  \n");
					decodeFilePath = keyboard.next();
					decoder.decode(csvFilePath,decodeFilePath);
				} else {
					System.out.println("You need to specify a file \n");
				}
